...
package com.chargedweb.swfsize
{
	...
	{	
		...
		/** @private SWFSize value types declaration **/
		...
		/** @private browser window metrics **/
		private var _windowWidth:Number = 0;
		private var _windowHeight:Number = 0;
		
		/** @private holds the value type (TYPE_ABSOLUTE or TYPE_RELATIVE) **/
		private var valueType:String;
		
		/** @private ExIn availability flag **/
		private var available:Boolean = ExternalInterface.available;
	
		/** @private init hack timer (addCallBack needs time to register callbacks) **/
		private var initTimer:Timer = new Timer(50);
		
		/** @private init result holder **/
		private var initResult:int = 0;
		
		/** @private js raw result **/
		...
		private function init():void
		{
			...
			if (available)
			{
				...
				// @note don't need this line any more | just use the hack
