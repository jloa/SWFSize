...
package com.chargedweb.swfsizedemo
{
	...
	/**
	 * SWFSizeDemoFlash class :: just a demo class of SWFSize usage for Adobe Flash
	 */
	public class SWFSizeDemoFlash extends MovieClip
	{
		// SWFSize ref
		 ...
		 * Constructor
		 */ 
		public function SWFSizeDemoFlash()
		{
			super();
			init();
		}
